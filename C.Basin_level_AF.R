...
Fig_S10 <- ggplot(data = AF_Basin_melted, aes(x = Purpose, y = Number_contributing, color = Purpose)) +
  geom_point() +
...
Fig_S9 <- ggplot(AF_dam_basin, aes(x = Purp, y = AF, fill = Purp)) +
...
ggsave(path = "../visualisations/", filename = "Fig_S9.png", Fig_S9, dpi = 600, 
       width = 15.9, height = 10 , unit = "cm")
ggsave(path = "../visualisations/", filename = "Fig_S10.png", Fig_S10, dpi = 600, 
