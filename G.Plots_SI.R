...
Fig_S2 <- ggplot(DF_all, aes(x=Basin, y=Value, fill=Type))+
...
Fig_S7 <- Area_wrap_plot + geom_smooth(method = 'lm', se = FALSE, color = "black")
...
### Save files ----
ggsave(path = "../visualisations/", filename = "Fig_S2.png", Fig_S2, 
       dpi = 600, width = 14, height = 6 , unit = "cm")
ggsave(path = "../visualisations/", filename = "Fig_S3.png", Fig_S3, dpi = 600,
       width = 15.92, height = 7 , unit = "cm")
ggsave(path = "../visualisations/", filename = "Fig_S4.png", Fig_S4, dpi = 600,
       width = 15.92, height = 7 , unit = "cm")
ggsave(path = "../visualisations/", filename = "Fig_S5.png", Fig_S5, dpi = 600, 
       width = 12, height = 5 , unit = "cm")
ggsave(path = "../visualisations/", filename = "Fig_S6.png", Fig_S6, dpi = 600, 
       width = 12, height = 5 , unit = "cm")
ggsave(path = "../visualisations/", filename = "Fig_S7.png", Fig_S7, dpi = 600, 
       width = 15.9, height = 10 , unit = "cm")
ggsave(path = "../visualisations/", filename = "Fig_S8.png", Fig_S8, dpi = 600, 
       width = 13, height = 5 , unit = "cm")
