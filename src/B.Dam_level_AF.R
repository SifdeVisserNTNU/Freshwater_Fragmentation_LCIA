...
Fig_B1 <- ggplot(example, aes(x = rank, y = AF, color = num_purp, group = num_purp)) +
  geom_line() +
  geom_point() +
  theme_light() +
...
ggsave(path = "../visualisations/", filename = "Fig_B1.png", Fig_B1,
       dpi = 1000, width = 5512, height = 2362, units = "px")
