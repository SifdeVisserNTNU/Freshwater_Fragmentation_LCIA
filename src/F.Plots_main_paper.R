...
### Save plots ----
ggsave(path = "../visualisations/", filename = "Fig_1.png", Fig_1, dpi = 1000,
       width = 3543, height = 2362, unit = "px")
ggsave(path = "../visualisations/", filename = "Fig_2.png", Fig_2, dpi = 1000, 
       width = 7480, height = 3937, unit = "px")
ggsave(path = "../visualisations/", filename = "Fig_3.png", Fig_3, dpi = 1000, 
       width = 5512, height = 5905, unit = "px")
